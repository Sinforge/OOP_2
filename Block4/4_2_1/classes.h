...
private:
	string name6;
public:
	CL_6(string name6) : CL_1(name6), CL_2(name6), CL_3(name6) {
		this->name6 = name6 + "_6\n";
	}
	void get_name() {
		cout << this->name6;
...
private:
	string name7;
public:
	CL_7(string name7) : CL_1(name7), CL_4(name7), CL_5(name7) {
		this->name7 = name7 + "_7\n";
	}
	void get_name() {
		cout << this->name7;
...
private:
	string name8;
public:
	CL_8(string name8) : CL_1(name8), CL_6(name8), CL_7(name8) {
		this->name8 = name8 + "_8\n";
	}
